...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        response = f"❌ 𝘼𝘾𝘾𝙀𝙎𝙎 𝘿𝙄𝙉𝙄𝙀𝘿. 𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙏𝙊 𝙊𝙒𝙉𝙀𝙍 -@HARSHx08"
...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id not in users or datetime.datetime.now() > datetime.datetime.strptime(users[user_id], '%Y-%m-%d %H:%M:%S'):
        await update.message.reply_text("❌ 𝙔𝙊𝙐 𝘼𝙍𝙀 𝙉𝙊𝙏 𝘼𝙐𝙏𝙊𝙍𝙄𝙕𝙀𝘿. 𝘿𝙈 𝙊𝙒𝙉𝙀𝙍 @HARSHx08")
        return
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id not in users or datetime.datetime.now() > datetime.datetime.strptime(users[user_id], '%Y-%m-%d %H:%M:%S'):
        await update.message.reply_text("𝙏𝘼𝙋 𝙏𝙊 𝘾𝙊𝙈𝙈𝘼𝙉𝘿. /babatillu\n\n𝙅𝙊𝙄𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 - https://t.me/ddosgrp/26l")
        return
...
async def stop(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id not in users or datetime.datetime.now() > datetime.datetime.strptime(users[user_id], '%Y-%m-%d %H:%M:%S'):
        await update.message.reply_text("𝙏𝙊𝙋 𝙏𝙊 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 /babatillu\n\n𝙅𝙊𝙄𝙉 𝙈𝙔 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 𝘾𝙃𝘼𝙉𝙉𝙀𝙇- https://t.me/ddosgrp/26")
        return
